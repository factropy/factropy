...
random_seed = rands(0,1000,1)[0];

//width of segment
segment_width = 15;

//segment length relative to width
length_multiplier = rands(3,6,1)[0];

//number of iterations
number_of_iterations = rands(5,8,1)[0];

level_of_smoothness = 8;
...
translate([0,0,-0.5]) scale([0.01,0.01,0.01]) union()
{
